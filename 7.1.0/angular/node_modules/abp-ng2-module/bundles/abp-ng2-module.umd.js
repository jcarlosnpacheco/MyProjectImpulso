(function (global, factory) {
    ...
    TokenService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function TokenService_Factory() { return new TokenService(); }, token: TokenService, providedIn: "root" });
    ...
    PermissionCheckerService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function PermissionCheckerService_Factory() { return new PermissionCheckerService(); }, token: PermissionCheckerService, providedIn: "root" });
    ...
    FeatureCheckerService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function FeatureCheckerService_Factory() { return new FeatureCheckerService(); }, token: FeatureCheckerService, providedIn: "root" });
    ...
    LocalizationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function LocalizationService_Factory() { return new LocalizationService(); }, token: LocalizationService, providedIn: "root" });
    ...
    MessageService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function MessageService_Factory() { return new MessageService(); }, token: MessageService, providedIn: "root" });
    ...
    AbpMultiTenancyService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AbpMultiTenancyService_Factory() { return new AbpMultiTenancyService(); }, token: AbpMultiTenancyService, providedIn: "root" });
    ...
    NotifyService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function NotifyService_Factory() { return new NotifyService(); }, token: NotifyService, providedIn: "root" });
    ...
    AbpSessionService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AbpSessionService_Factory() { return new AbpSessionService(); }, token: AbpSessionService, providedIn: "root" });
    ...
    SettingService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function SettingService_Factory() { return new SettingService(); }, token: SettingService, providedIn: "root" });
    ...
    AbpUserConfigurationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AbpUserConfigurationService_Factory() { return new AbpUserConfigurationService(i0__namespace.ɵɵinject(i1__namespace.HttpClient)); }, token: AbpUserConfigurationService, providedIn: "root" });
    ...
    AbpHttpConfigurationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function AbpHttpConfigurationService_Factory() { return new AbpHttpConfigurationService(i0__namespace.ɵɵinject(MessageService), i0__namespace.ɵɵinject(LogService)); }, token: AbpHttpConfigurationService, providedIn: "root" });
