...
{
    public abstract class MyProjectImpulsoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyProjectImpulsoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyProjectImpulsoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyProjectImpulsoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyProjectImpulsoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyProjectImpulsoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyProjectImpulsoDbContext, Task<T>> func)
        {
            T result;
